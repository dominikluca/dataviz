...
df_story_combined <- subset_df %>%
  ...
  summarise(
    ...
    # Calculating averages for rainy vs. sunny days
...
# Global average for the reference line
mean_resilience <- mean(df_story_combined$resilience_index, na.rm = TRUE)

# Status for color-coding the data points
